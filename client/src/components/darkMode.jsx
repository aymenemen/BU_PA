...
const DarkMode = (props) => {
  ...
  return (
    <>
      <button
        className={`${props.className} text-gray-900 bg-transparent focus:outline-none hover:scale-110 font-medium border-none rounded-full text-sm px-3 py-1.5 me-2 -mt-1 mx-4 dark:bg-transparent dark:text-white dark:border-gray-600 dark:hover:scale-110 dark:hover:border-gray-600 dark:focus:ring-gray-700`}
